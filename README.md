...
- [SECTION 5: Mailchimp Field Mapping – Customers Down](#section-4-mailchimp-field-mapping--customers-down)
- [SECTION 6: Mailchimp Item Field Mapping & Ticket Information](#section-5-mailchimp-item-field-mapping--ticket-information)
- [SECTION 7: Mailchimp Tags](#section-6-mailchimp-tags)
- [SECTION 8: Mailchimp Customer Tags](#section-7-mailchimp-customer-tags)
- [SECTION 9: Mark All Mailchimp Messages as Read](#section-8-mark-all-mailchimp-messages-as-read)
- [SECTION 10: Run Mailchimp Connector Button](#section-9-run-mailchimp-connector-button)
- [SECTION 11: Mailchimp Customer Status View](#section-10-mailchimp-customer-status-view)
- [SECTION 12: Mailchimp Connector Execution and Sync Timing](#section-11-mailchimp-connector-execution-and-sync-timing)
